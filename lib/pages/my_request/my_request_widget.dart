...
export 'my_request_model.dart';

class MyRequestWidget extends StatefulWidget {
  const MyRequestWidget({Key? key}) : super(key: key);

  @override
  _MyRequestWidgetState createState() => _MyRequestWidgetState();
}

class _MyRequestWidgetState extends State<MyRequestWidget>
    with TickerProviderStateMixin {
  late MyRequestModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyRequestModel());
                        ...
                        children: [
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed('requestDetails');
                              },
                              child: Row(
                                mainAxisSize: MainAxisSize.max,
                                mainAxisAlignment:
